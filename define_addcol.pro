...
;    bandfloat = strmid(bandfloat,0,strpos(bandfloat,',',/reverse_search))+']'
    ...
    addcol = [['NEIGH_GALFIT', '0'], ['CHISQ_GALFIT','0'], $
              ...
              ['ORG_IMAGE', '" "'], ['FILE_GALFIT', '" "'], $
              ['X_GALFIT', '0.'], ['XERR_GALFIT', '0.'], $
              ['X_CHEB_GALFIT', hlpcheb0], ['XERR_CHEB_GALFIT', hlpcheb0], $
              ['Y_GALFIT', '0.'], ['YERR_GALFIT', '0.'], $
              ['Y_CHEB_GALFIT', hlpcheb1], ['YERR_CHEB_GALFIT', hlpcheb1], $
              ['MAG_GALFIT', '0.'], ['MAGERR_GALFIT', '0.'], $
              ['MAG_CHEB_GALFIT', hlpcheb2], ['MAGERR_CHEB_GALFIT', hlpcheb2], $
              ['RE_GALFIT', '0.'], ['REERR_GALFIT', '0.'], $
              ['RE_CHEB_GALFIT', hlpcheb3], ['REERR_CHEB_GALFIT', hlpcheb3], $
              ['N_GALFIT', '0.'], ['NERR_GALFIT', '0.'], $
              ['N_CHEB_GALFIT', hlpcheb4], ['NERR_CHEB_GALFIT', hlpcheb4], $
              ['Q_GALFIT', '0.'], ['QERR_GALFIT', '0.'], $
              ['Q_CHEB_GALFIT', hlpcheb5], ['QERR_CHEB_GALFIT', hlpcheb5], $
              ['PA_GALFIT', '0.'], ['PAERR_GALFIT', '0.'], $
              ['PA_CHEB_GALFIT', hlpcheb6], ['PAERR_CHEB_GALFIT', hlpcheb6], $
              ['SKY_GALFIT', '0.'], ['PSF_GALFIT', '" "'], $
